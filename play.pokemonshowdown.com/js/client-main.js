...
focusRoom=function focusRoom(roomid){var _this$room$onParentEv,_this$room;
...
this.update();
(_this$room$onParentEv=(_this$room=this.room).onParentEvent)==null?void 0:_this$room$onParentEv.call(_this$room,'focus',undefined);
return true;
};_proto7.
