...
(function ($) {
	...
	this.ProxyPopup = Popup.extend({
		...
		initialize: function (data) {
			...
			var buf = '<form>';
			buf += '<p>Because of <a href="https://en.wikipedia.org/wiki/Same-origin_policy" target="_blank">your browser\'s security restrictions</a>, we need to do this manually:</p>';
