...
};return _this2;}var _proto2=ChatTextEntry.prototype;_proto2.componentDidMount=function componentDidMount(){var _this3=this;this.subscription=PS.user.subscribe(function(){_this3.forceUpdate();});var textbox=this.base.children[0].children[1];if(textbox.tagName==='TEXTAREA')this.textbox=textbox;this.miniedit=new MiniEdit(textbox,{setContent:function(text){textbox.innerHTML=formatText(text,false,false,true)+'\n';},onKeyDown:this.onKeyDown});if(this.base)this.update();};_proto2.componentWillUnmount=function componentWillUnmount(){if(this.subscription){this.subscription.unsubscribe();this.subscription=null;}};_proto2.submit=function submit(){this.props.onMessage(this.getValue());this.historyPush(this.getValue());this.setValue('');this.update();return true;};_proto2.
getValue=function getValue(){
return this.miniedit?this.miniedit.getValue():this.textbox.value;
};_proto2.
setValue=function setValue(value,selection){
if(this.miniedit){
...
var anyModifier=ev.ctrlKey||ev.altKey||ev.metaKey||ev.shiftKey;
if(ev.keyCode===13&&!ev.shiftKey){
return this.submit();
}else if(ev.keyCode===13&&this.miniedit){
...
var _this$getSelection=this.getSelection(),start=_this$getSelection.start,end=_this$getSelection.end;
...
this.setValue(value,{start:start,end:end});
return true;
};_proto2.
...
ChatTextBox=function(_preact$Component2){_inheritsLoose(ChatTextBox,_preact$Component2);function ChatTextBox(){return _preact$Component2.apply(this,arguments)||this;}var _proto3=ChatTextBox.prototype;_proto3.
shouldComponentUpdate=function shouldComponentUpdate(){
return false;
};_proto3.
render=function render(){
return preact.h("pre",{"class":this.props["class"],placeholder:this.props.placeholder},'\n');
...
room.update(null);
};return _this4;}var _proto4=ChatPanel.prototype;_proto4.focus=function focus(){var _this5=this;setTimeout(function(){_this5.base.querySelector('textarea, pre.textbox').focus();},0);};_proto4.
render=function render(){
...
ChatUserList=function(_preact$Component3){_inheritsLoose(ChatUserList,_preact$Component3);function ChatUserList(){var _this6;for(var _len3=arguments.length,args=new Array(_len3),_key3=0;_key3<_len3;_key3++){args[_key3]=arguments[_key3];}_this6=_preact$Component3.call.apply(_preact$Component3,[this].concat(args))||this;_this6.
subscription=null;_this6.
state={
expanded:false
};_this6.
toggleExpanded=function(){
_this6.setState({expanded:!_this6.state.expanded});
};return _this6;}var _proto5=ChatUserList.prototype;_proto5.
componentDidMount=function componentDidMount(){var _this7=this;
this.subscription=this.props.room.subscribe(function(msg){
if(!msg)_this7.forceUpdate();
});
};_proto5.
...
ChatLog=function(_preact$Component4){_inheritsLoose(ChatLog,_preact$Component4);function ChatLog(){var _this8;for(var _len4=arguments.length,args=new Array(_len4),_key4=0;_key4<_len4;_key4++){args[_key4]=arguments[_key4];}_this8=_preact$Component4.call.apply(_preact$Component4,[this].concat(args))||this;_this8.



log=null;_this8.
subscription=null;return _this8;}var _proto6=ChatLog.prototype;_proto6.
...
_this9.props.room.setUsers(count,usernames);
return;
case'join':case'j':case'J':
_this9.props.room.addUser(tokens[1]);
break;
case'leave':case'l':case'L':
_this9.props.room.removeUser(tokens[1]);
break;
case'name':case'n':case'N':
_this9.props.room.renameUser(tokens[1],tokens[2]);
break;
}
if(!_this9.props.noSubscription)_this9.log.add(tokens);
});
